    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-sponsor__popup-text">
            ...
            <p> Во-первых&nbsp;-&nbsp;полная реализация премайна ПРИЗМ (10 млн монет). Это как ico в&nbsp;других проектах. Только после
                ...
                ПРИЗМ&nbsp;-&nbsp;это подключение к&nbsp;онлайн и&nbsp;офлайн биржам/сертифицированным криптообменникам, подключение
            ...
            <p>Проект использует технологию блокчейн, за&nbsp;основу используется ядро NXT&nbsp;Core, которое в&nbsp;процессе
                ...
                новых монет отвязана от&nbsp;процесса майнинга/форжинга, как это&nbsp;происходит в&nbsp;любых других криптовалютах
                (Proof-of Work/Proof-of-Stake).</p>
            ...
            <p>Как писалось выше, в&nbsp;данный момент идет распределение предмайнинга, для&nbsp;выполнения дальнейшей стратегии
                ...
                ПРИЗМ пройти в&nbsp;кратчайший срок тот путь развития, который был у&nbsp;Биткойн. Мы уверены, что&nbsp;ПРИЗМ не&nbsp;только
                догонит биткойн по&nbsp;капитализации и&nbsp;численности пользователей, но&nbsp;и&nbsp;обойдёт его, так&nbsp;как&nbsp;технически
...
<div id="sponsor2" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-sponsor__popup-text">
            ...
            <p>SMSCHAIN представляет собой не&nbsp;имеющую аналогов P2B&nbsp;(peer-to-business) систему, выполняющую функционал
                СМС-шлюза для&nbsp;отправки служебных сообщений различных веб-сервисов. Приложение дает возможность любому
                владельцу Android-смартфона продать неиспользованные СМС, включенные в&nbsp;тарифный план, компаниям,
            ...
            <p>Сегодня основной A2P-трафик генерируется с&nbsp;помощью GSM&nbsp;СМС-шлюзов. Это&nbsp;довольно дорогостоящее
            ...
            <p>Роль посредника между пользователями приложения и&nbsp;бизнесом будут выполнять СМС-агрегаторы. Они будут
                создавать заявки-аукционы, в&nbsp;каждом из&nbsp;которых будут указаны назначение, объем трафика, стоимость и&nbsp;сам
            ...
            <p>“Мы верим, что&nbsp;рынок A2P сообщений остро нуждается в&nbsp;цифровой трансформации. Блокчейн открывает
                ...
                уверенность в&nbsp;исполнении задачи по&nbsp;доставке SMS-сообщений”&nbsp;-&nbsp;добавил Олег Макаров, COO&nbsp;SMSCHAIN.</p>
            <p>
                <b>О SMSCHAIN</b>
            </p>
            <p>SMSCHAIN&nbsp;-&nbsp;IT/телеком компания, которая занимается разработкой инфраструктуры уникального P2B сервиса.
                ...
                международного шлюза для&nbsp;СМС-рассылок, платформы СМС-маркетинга, клиентами которой являются 2 из&nbsp;3 ключевых лидеров
                рынка.</p>
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-sponsor__popup-text">
            ...
            <p><b>Изменить имидж рынка форекс</b> возможно только с&nbsp;помощью глобальных реформ. Консервативные методы
                регулирования устарели и&nbsp;уже не&nbsp;способны выполнять свои задачи в&nbsp;интернет-трейдинге. <b>SERENITY</b> решает
