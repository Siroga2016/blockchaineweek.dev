                            ...
                            <div class="b-programm__table-item_right">
                                ...
                                <div class="b-programm__table-item-text">
                                    ...
                                    <div class="position">
                                        ...
                                        при Комитете Государственной Думы ФС РФ по экономической промышленности,
            ...
            <div class="b-sponsor__wrap">
                ...
                <div class="b-sponsor__item">
                    ...
                    <div class="b-sponsor__item-bottom">
                        ...
                        <div>
                            <div class="b-sponsor__video-link j-video8">Видеопрезентация</div>
            ...
            <div class="b-sponsor__wrap">
                <div class="b-sponsor__item">
                    ...
                    <div class="b-sponsor__item-bottom">
                        ...
                        <div>
                            <div class="b-sponsor__video-link j-video10">Видеоинтервью</div>
            ...
            <div class="b-sponsor__wrap">
                <div class="b-sponsor__item">
                    ...
                    <div class="b-sponsor__item-bottom">
                        <div class="b-sponsor__btn j-sponsor5">О проекте</div>
                        <div>
                            <div class="b-sponsor__video-link j-video7">Видеоинтервью</div>
                            <a href="../files/B2Broker.pdf" target="_blank" class="b-sponsor__link">Смотреть презентацию</a>
                        </div>
                    </div>
                </div>
                <div class="b-sponsor__item">
                    ...
                    <div class="b-sponsor__item-bottom">
                        <div class="b-sponsor__btn j-sponsor8">О проекте</div>
                        <div>
                            <div class="b-sponsor__video-link j-video9">Видеоинтервью</div>
                            <a href="../files/ETHLend.pdf" target="_blank" class="b-sponsor__link">Смотреть презентацию</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="b-sponsor__wrap">
                <div class="b-sponsor__item">
                    <div class="b-sponsor__item-top">
                        ...
                        <a href="http://bonumchain.com/" target="_blank" class="b-sponsor__img zodiaq"></a>
                    </div>
                    <div class="b-sponsor__text">
                        Мы&nbsp;создаем финансовую блокчейн корпорацию, в&nbsp;основе которой существующий банк
                        с&nbsp;лицензией на&nbsp;осуществление операций с&nbsp;крипто и&nbsp;фиатными валютами.
                        Другие компоненты&nbsp;–&nbsp;биржа, платежная система, карты, холодные кошельки&nbsp;и&nbsp;тд.&nbsp;-&nbsp;позволят
                        проводить все операции из&nbsp;одного окна. Организация будет эволюционировать вместе с&nbsp;рынком
                        и&nbsp;законодательством, что&nbsp;обеспечит стабильность и&nbsp;долгосрочное развитие.
                    </div>
                    <div class="b-sponsor__item-bottom">
                ...
                <div class="b-sponsor__item">
                    <div class="b-sponsor__item-top">
                        <div class="b-sponsor__title">TravelChain</div>
                        <a href="https://travelchain.io/" target="_blank" class="b-sponsor__img travelchain"></a>
                    </div>
                    <div class="b-sponsor__text">
                        TravelChain&nbsp;-&nbsp;это&nbsp;децентрализованная блокчейн-платформа, которая предоставляет
                        доступ к&nbsp;достоверной и&nbsp;структурированной информации в&nbsp;сфере туризма.
                        Это&nbsp;позволяет компаниям лучше знать своих клиентов, а&nbsp;путешественникам получать
                        персонализированный сервис.
                    </div>
                    <div class="b-sponsor__item-bottom">
                        <div class="b-sponsor__btn j-sponsor17">О проекте</div>
                        <div>
                            <div class="b-sponsor__video-link j-video6">Видеопрезентация</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="b-sponsor__wrap">
                <div class="b-sponsor__item">
                    <div class="b-sponsor__item-top">
                        ...
                        <a href="http://arbi.expert/" target="_blank" class="b-sponsor__img arbi"></a>
                    </div>
                    <div class="b-sponsor__text">
                        Arbi&nbsp;-&nbsp;escrow сервис для&nbsp;ICO&nbsp;#1.
                        <br>
                        Проект направлен на&nbsp;защиту интересов инвесторов в&nbsp;ICO, путем применения механизма
                        поэтапного финансирования. Благодаря привлечению лицензированных escrow агентов, аудиту
                        и&nbsp;профессиональному составлению escrow соглашений, Arbi, практически полностью,
                        исключает для&nbsp;инвестора риск стать жертвой SCAM проекта и неосмотрительных действий
                        членов команды.
                    </div>
                    <div class="b-sponsor__item-bottom">
...
<div id="sponsor5" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-video__wrapper">
            <div class="b-video b-video-sp-7">
                <img src="/img/b2broker_preview.png" alt="">
                <div id="youtube-sponsor-video-b2broker-click"></div>
            </div>
        </div>
        <div class="b-sponsor__popup-text">
...
<div id="sponsor-video7" class="sponsor video-sp-7">
    <span class="modal_close">X</span>
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">B2Broker</div>
        ...
        <div class="b-video__wrapper">
            <div id="youtube-sponsor-video-b2broker"></div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>На текущий момент B2BX — это агрегатор криптовалютной ликвидности для маржинальной и биржевой торговли и дистрибьюции ликвидности брокерскими компаниями. Мы планируем сделать первую официальную криптовалютную B2B-биржу или маркетплейс, в который подключим не менее 5% от количества текущих Forex и фондовых брокеров.</p>
...
<div id="sponsor8" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-video__wrapper">
            <div class="b-video b-video-sp-9">
                <img src="../img/ethlend_preview.png" alt="">
                <div id="youtube-sponsor-video-ethlend-click"></div>
            </div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>ETHLend&nbsp;-&nbsp;это&nbsp;100% равноправная платформа для&nbsp;децентрализованногокредитования,
                разработанная на&nbsp;основе сети Ethereum. Одно&nbsp;из&nbsp;главных преимуществ децентрализованного
                кредитования на&nbsp;основе blockchain&nbsp;–&nbsp;это&nbsp;предоставление доступа<br>
                к&nbsp;всемирному капиталу и&nbsp;снижение зависимости от&nbsp;банковской инфраструктуры.</p>
            <p>Прогнозируется, что&nbsp;всемирный рынок P2P-кредитования вырастет<br> по&nbsp;среднегодовому темпу
                роста на&nbsp;53.06% в&nbsp;течение&nbsp;2016-2020&nbsp;гг. <br>Также возрастет необходимость
                в&nbsp;безопасном методе кредитования <br>на&nbsp;основе blockchain. </p>
            <p>Система Умных Контрактов (SmartContracts)vETHlend обеспечивает мгновенное и&nbsp;безопасное
                кредитование, предоставляя заём в&nbsp;любое время и&nbsp;в&nbsp;любом месте, тем&nbsp;самым
                органически дополняя рынок P2Pкредитования путем предоставления возможности кредиторам<br>
                и&nbsp;заемщикам привлекать средства из&nbsp;любой финансовой организации<br> в&nbsp;мире.
                Дополнительно данная система снижает и&nbsp;уравнивает процентные ставки по&nbsp;всему миру,
                предоставляя глобальный пул ликвидности <br>на&nbsp;равных основах.</p>
            <p>Первый кредит был выдан нами 8&nbsp;июня&nbsp;2017 года благодаря полностью рабочей альфа-версии
                протокола, гдевместо кредитования<br> на&nbsp;основефиатных валют, участники использовали валюту
                Ethereum. Процесс кредитования полностью децентрализован&nbsp;-&nbsp;никто, включая ETHLend,
                не&nbsp;может изменить, манипулировать или&nbsp;повлиять на&nbsp;процесс выдачи или&nbsp;получения
                кредита, что&nbsp;делает систему безопасной по&nbsp;своему строению.</p>
            <p>В&nbsp;нашей платформе в&nbsp;качестве залоговых средств заёмщик использует ERC-20 токены, которые
                представляютсобой “дигитализированный” эквивалент стоимости актива компании в&nbsp;системе blockchain.
                На&nbsp;данный момент рынок ERC-20 токенов оценивается в&nbsp;несколько миллиардов долларов США.</p>
            <p>Мы&nbsp;ожидаем ускорение процесса «токенизации» в&nbsp;ближайшем будущем: заёмщик сможет с&nbsp;легкостью
                купить недвижимость в&nbsp;Канаде и&nbsp;оценить ее&nbsp;в&nbsp;соответствии с&nbsp;ERC-20 токеном,
                чтобы&nbsp;в&nbsp;дальнейшем привлечь средства через ETHLend. Таким образом, заёмщик получает доступ
                к&nbsp;инвесторам со&nbsp;всего мира, а&nbsp;не&nbsp;только к&nbsp;локальным игрокам,
                что&nbsp;обеспечивает свободную конкуренцию по&nbsp;процентным ставкам. </p>
            <p>ETHLend&nbsp;–&nbsp;это&nbsp;международная команда, настроенная изменить и&nbsp;расширить общественное
                мнение о&nbsp;доступности и&nbsp;возможностях кредитования. </p>
        </div>
    </div>
    <a href="files/ETHLend.pdf" target="_blank" class="b-sponsor__presentation">Смотреть презентацию</a>
</div>

<div id="sponsor-video9" class="sponsor video-sp-9">
    <span class="modal_close">X</span>
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">ETHLend</div>
        ...
        <div class="b-video__wrapper">
            <div id="youtube-sponsor-video-ethlend"></div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>ETHLend&nbsp;-&nbsp;это&nbsp;100% равноправная платформа для&nbsp;децентрализованногокредитования,
                разработанная на&nbsp;основе сети Ethereum. Одно&nbsp;из&nbsp;главных преимуществ децентрализованного
...
<div id="sponsor9" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-video__wrapper">
            <div class="b-video b-video-sp-10">
                <img src="../img/faceter_preview.png" alt="">
                <div id="youtube-sponsor-video-faceter-click"></div>
            </div>
        </div>
        <div class="b-sponsor__popup-text">
...
<div id="sponsor-video10" class="sponsor video-sp-10">
    <span class="modal_close">X</span>
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">FACETER</div>
        ...
        <div class="b-video__wrapper">
            <div id="youtube-sponsor-video-faceter"></div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>Faceter.io&nbsp;—&nbsp;международный проект основан тремя единомышленниками из&nbsp;разных&nbsp;стран, которые&nbsp;с&nbsp;2014&nbsp;года
                совместно ведут исследования и&nbsp;разработки в&nbsp;области распознавания визуальных образов с&nbsp;помощью
...
<div id="sponsor10" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-video__wrapper">
            <div class="b-video b-video-sp-8">
                <img src="../img/minsol_preview.png" alt="">
                <div id="youtube-sponsor-video-minsol-click"></div>
            </div>
        </div>
        <div class="b-sponsor__popup-text">
...
<div id="sponsor-video8" class="sponsor video-sp-8">
    <span class="modal_close">X</span>
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">Mining Solutions</div>
        ...
        <div class="b-video__wrapper">
            <div id="youtube-sponsor-video-minsol"></div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>Развивая свой майнинговый центр, специалисты компании Mining Solutions обратили внимание на&nbsp;то,
                что&nbsp;при&nbsp;использовании GPU&nbsp;не&nbsp;решено много простых задач. В&nbsp;частности, простой
    ...
    <div class="b-sponsor__popup">
        ...
        <div class="b-sponsor__popup-text">
            ...
            <p>Способ реализации&nbsp;–&nbsp;создание платформы международных транзакций на&nbsp;основе универсальной
                ...
                и&nbsp;клиринга, валютных операций без&nbsp;валют третьих стран.</p>
            <p>Финансовая модель ZODIAQ, рассчитана на&nbsp;постоянный рост за&nbsp;счет капитализации доходов системы. Часть
                прибыли каждого компонента системы в&nbsp;автоматическом режиме направляется на&nbsp;пополнение фонда.
                Распределением управляет децентрализованное автономное приложение.</p>
            <p>Прибыль корпорации ZODIAQ распределяется на&nbsp;основе открытой математической модели, запрограммированной
...
<div id="sponsor17" class="sponsor">
    ...
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">TravelChain</div>
            <a href="https://travelchain.io/" target="_blank" class="b-sponsor__img travelchain_white"></a>
        </div>
        <div class="b-video__wrapper">
            <div class="b-video b-video-sp-6">
                <img src="../img/TravelChain_preview.jpg" alt="">
                <div id="youtube-sponsor-video-travelchain-click"></div>
            </div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>Наша миссия предоставить равный доступ для&nbsp;обмена данными между всеми игроками рынка. Мы&nbsp;создаем
                публичный блокчейн с&nbsp;открытым кодом, который управляется всеми участниками туристического рынка.
                Мы&nbsp;верим, что&nbsp;с&nbsp;его&nbsp;развитием появятся прорывные решения, которые создадут новые
                стандарты того, как&nbsp;люди будут путешествовать в&nbsp;ближайшем будущем.</p>
        </div>
    </div>
</div>

<div id="sponsor-video6" class="sponsor video-sp-6">
    <span class="modal_close">X</span>
    <div class="b-sponsor__popup">
        <div class="b-sponsor__item-top">
            <div class="b-sponsor__title">TravelChain</div>
        ...
        <div class="b-video__wrapper">
            <div id="youtube-sponsor-video-travelchain"></div>
        </div>
        <div class="b-sponsor__popup-text">
            <p>Наша миссия предоставить равный доступ для&nbsp;обмена данными между всеми игроками рынка. Мы&nbsp;создаем
                публичный блокчейн с&nbsp;открытым кодом, который управляется всеми участниками туристического рынка.
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    ...
    youtubeVideoPlayerSp6 = new YT.Player('youtube-sponsor-video-travelchain', {
        videoId: '9yl0N8YbB1w'
    });

    youtubeVideoPlayerSp6Click = new YT.Player('youtube-sponsor-video-travelchain-click', {
        videoId: '9yl0N8YbB1w'
    });

    youtubeVideoPlayerSp7 = new YT.Player('youtube-sponsor-video-b2broker', {
        videoId: '-trUZLquKIg'
    });

    youtubeVideoPlayerSp7Click = new YT.Player('youtube-sponsor-video-b2broker-click', {
        videoId: '-trUZLquKIg'
    });

    youtubeVideoPlayerSp8 = new YT.Player('youtube-sponsor-video-minsol', {
        videoId: '67UHsxpsPws'
    });

    youtubeVideoPlayerSp8Click = new YT.Player('youtube-sponsor-video-minsol-click', {
        videoId: '67UHsxpsPws'
    });

    youtubeVideoPlayerSp9 = new YT.Player('youtube-sponsor-video-ethlend', {
        videoId: '7LdpilfspIM'
    });

    youtubeVideoPlayerSp9Click = new YT.Player('youtube-sponsor-video-ethlend-click', {
        videoId: '7LdpilfspIM'
    });

    youtubeVideoPlayerSp10 = new YT.Player('youtube-sponsor-video-faceter', {
        videoId: 'X7SalmLKK5k'
    });
